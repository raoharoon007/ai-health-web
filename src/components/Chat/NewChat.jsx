        ...
        <div className={`relative flex flex-col w-full h-full bg-white sm:px-4 px-2 ${isChatActive
            ...
            {isChatActive ? (
                ...
                <div className="w-full max-w-5xl flex flex-col items-center z-10">
                    ...
                    <h1 className="text-lg sm:text-xl lg:text-[28px] 3xl:text-4xl font-medium text-primarytext mt-6 mb-4 sm:mb-6 text-center animate-left-to-right px-2 shrink-0">
