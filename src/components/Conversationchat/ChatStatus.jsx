...
const ChatStatus = ({ isRecording, isTranscribing, botStatus }) => {
    return (
        <div className="flex-none pt-4 sm:pt-8 pb-2 sm:pb-4 bg-white z-10 ">
            <div className="h-24 w-24 sm:h-35 sm:w-35 3xl:h-60 3xl:w-60 mx-auto transition-all duration-300 flex justify-center items-center rounded-full bg-blue-500/10">
                {botStatus === "replying" ? (
